            ...
            <div className="bg-[#282828] p-8 rounded-lg shadow-lg w-full max-w-md text-center">
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                    <input
                        ...
                        className="bg-[#3e3e3e] text-white p-3 rounded-md border border-transparent focus:border-green-500 focus:outline-none"
                        autoFocus
                    />
                    ...
                    <button
                        ...
                        className="bg-green-500 text-black font-bold py-3 px-4 rounded-full hover:scale-105 transition-transform disabled:opacity-50 disabled:cursor-not-allowed"
                    >
